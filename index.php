...
class Notes {
    ...
    public function fetchRawContent($id) {
        $stmt = $this->pdo->prepare('SELECT content FROM notes WHERE id = :ID');
        $stmt->bindParam(':ID', $id);
        $stmt->execute();
...
<?php foreach ($notes as $row): ?>
                            ...
                            <td class="text-right">
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-primary btn-sm" title="Get raw content" onclick="getRawContent(<?= $row['ID'] ?>)"><span class="fa fa-code"></span></button>
                                </div>
...
<?php endif; ?>
    ...
    <div class="container mt-5">
        ...
        <form role="form" action="index.php" method="GET">
            <button class="btn btn-danger" type="submit" name="clearAll"><span class="fa fa-trash-alt mr-2"></span>Clear All Notes</button>
        </form>
    </div>
